                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group{{ $errors->has('n_aluno') ? ' has-error' : '' }}">
                            <label for="n_aluno" class="col-md-4 control-label">Número de Aluno</label>

                            <div class="col-md-6">
                                <input id="n_aluno" type="number" class="form-control" name="n_aluno" required>
                        ...
                        <div class="form-group{{ $errors->has('curso') ? ' has-error' : '' }}">
                            <label for="n_aluno" class="col-md-4 control-label">Curso</label>

                            <div class="col-md-6">
                                <input id="curso" type="text" class="form-control" name="curso" required>
