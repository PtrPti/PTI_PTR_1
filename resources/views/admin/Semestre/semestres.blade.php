...
<div class="search-row" style="display: flex">
    <select name="search_ano_letivo" id="search-ano_letivo" class="select-input search-select" onchange="SearchInput('/searchSemestres')" style="margin: auto">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="#" id="createForm" enctype="multipart/form-data">
                    ...
                    <div class="row row-btn">
                        <div class="col-md-12">
                            <button type="button" class="btn btn-primary" onclick="Save('createForm', '/addSemestrePost')" style="display: inline-block !important">Criar</button>
                            <button type="button" class="btn btn-secondary" data-dismiss="modal" style="display: inline-block !important">Fechar</button>
                        </div>
                    </div>
                </form>
...
<div class="modal fade" id="addCsvFile" tabindex="-1" role="dialog" aria-labelledby="addCsvFileLabel" aria-hidden="true">
    <div class="modal-dialog admin" role="document" style="min-width: 500px">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="{{ route ('addSemestreCsv') }}" id="addCsvForm" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="row group">
                        <div class="col-md-12">
                    ...
                    <div class="row group">
                        <div class="col-md-12">
                            <p>Nota: Só são permitidos ficheiros .csv. O ficheiro tem de ter o formato: Semestre,DataInicio,DataFim,Ano</p>
                        </div>
                    </div>
                    <div class="row row-btn">
                        <div class="col-md-12">
