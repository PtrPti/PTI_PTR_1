...
<div class="flex-right">
            ...
            <div class="chat-popup" id="chat">
                <form action="{{ route('AddMensagem') }}" enctype="multipart/form-data" method="post" class="form-container">
                    ...
                    <div class="dropup">
                        ...
                        <label for="mensagem_docente"><b style ="position: relative;
            top: 70px;">Mensagens</b></label>
    ...
    top: 320px;">Enviar Feedback</button>
                        <button type="button" class="btn cancel" style ="position: absolute;
    top: 365px;" onclick="closeForm()">Fechar</button>
