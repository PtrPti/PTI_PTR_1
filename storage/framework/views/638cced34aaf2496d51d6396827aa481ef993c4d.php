...
<div class="nav_icons">
    <div class="" id="tab1"><img src="<?php echo e(asset('images/home_icon.png')); ?>"> Home </div>
    <div class="has-dropdown" id="tab2"><img src="<?php echo e(asset('images/disciplinas_icon.png')); ?>"> Disciplinas 
        <ul class="dropdown">
    ...
    <div class="has-dropdown" id="tab3"><img src="<?php echo e(asset('images/projetos_icon.png')); ?>"> Projetos 
        <ul class="dropdown">
