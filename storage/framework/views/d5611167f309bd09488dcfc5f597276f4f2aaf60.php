    ...
    <div class="row">
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                <div class="panel-heading col-md-6 registo-active" id="registoAluno" onclick="ShowRegistoAluno()"><?php echo e(__('change.aluno')); ?> </div>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="<?php echo e(route ('registarPost')); ?>" id="formAluno">
                        ...
                        <div class="form-group<?php echo e($errors->has('data_nascimento') ? ' has-error' : ''); ?>">
                            ...
                            <div class="col-md-6">
                                <input id="data_nascimento" type="text" class="date form-control" name="data_nascimento" value="<?php echo e(old('data_nascimento')); ?>" required autofocus>
                        ...
                        <div class="form-group<?php echo e($errors->has('grau_academico_id') ? ' has-error' : ''); ?>">
                            <label for="grau_academico_id" class="col-md-4 control-label"><?php echo e(__('change.grauAcademico')); ?></label>
                    ...
                    <form class="form-horizontal" method="POST" action="<?php echo e(route ('registarPost')); ?>" id="formProfessor">
                        ...
                        <div class="form-group<?php echo e($errors->has('numero') ? ' has-error' : ''); ?>">
                            <label for="numero" class="col-md-4 control-label"><?php echo e(__('change.numDocente')); ?></label>
