...
<div class="addBtn-row">
    <button type="button" class="addBtn" onclick="AddGrupo(<?php echo $projeto_id ?>)">Adicionar grupo</button>
        ...
        $.ajax({
            ...
            success: function(data) {
                for(var i = 0; i < data.length; i++) {
                    $(".tableGrupos").append("<tr id='grupo_" + data[i][2] + "'><td><i class='fas fa-trash-alt' onclick='DeleteGroup(" + data[i][2] + ")'></i></td><td>Grupo " + data[i][0] + "</td><td>0/" + data[i][1] + "</td><td>-</td></tr>");
                }
            }
        });
    }
